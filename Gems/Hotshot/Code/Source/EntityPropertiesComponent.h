...
#include <Hotshot/EntityPropertiesInterface.h>

namespace Hotshot
{
    /*
    * TODO: Register this component in your Gem's AZ::Module interface by inserting the following into the list of m_descriptors:
    *       EntityPropertiesComponent::CreateDescriptor(),
    */

    class EntityPropertiesComponent
        : public AZ::Component
        , public EntityPropertiesRequestBus::Handler
    {
    public:
        AZ_COMPONENT_DECL(EntityPropertiesComponent);
